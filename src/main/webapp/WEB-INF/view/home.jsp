...
<html>
	...
	<body>
		...
		<div>
			...
			<a href="${pageContext.request.contextPath}/UpdateMemberPwFormController">비밀번호 수정</a>
			<a href="${pageContext.request.contextPath}/UpdateMemberFormController">회원정보 수정</a>
